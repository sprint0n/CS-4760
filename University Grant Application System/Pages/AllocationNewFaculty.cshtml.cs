...
{
    public class NewFacultyAllocationRowViewModel
    {
    ...
    public class NewFacultyAllocationPageModel : PageModel
    {
        private readonly University_Grant_Application_SystemContext _context;

        public NewFacultyAllocationPageModel(University_Grant_Application_SystemContext context)
        {
            _context = context;
        }
        ...
        public List<NewFacultyAllocationRowViewModel> Applications { get; set; }
        ...
        public async Task OnGetAsync()
        {
            ...
            Applications = await (
                ...
                select new NewFacultyAllocationRowViewModel
                {
                    Id = f.Id,
                    Title = f.Title,
